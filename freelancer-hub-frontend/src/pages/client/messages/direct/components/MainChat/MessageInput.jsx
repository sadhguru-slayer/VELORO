                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="min-w-0">
                    <p className={`text-sm font-medium text-gray-800 ${isMobile ? 'truncate' : 'break-words'}`}>
                      <span className="text-teal-600">Pro</span> unlocks 1GB files
                    </p>
                  ...
                  <button
                    ...
                    className="flex-shrink-0 bg-gradient-to-r from-teal-500 to-blue-500 text-white px-4 py-1.5 rounded-full text-sm font-medium hover:from-teal-600 hover:to-blue-600 transition-all duration-200 shadow-sm hover:shadow-md"
                  >
                    Upgrade
                  </button>
                </div>
            ...
            >
              <div className="mb-4 p-4 bg-gray-100/50 rounded-lg flex flex-col sm:flex-row items-start sm:items-center gap-3">
                <div className="flex items-center space-x-3 w-full sm:w-auto">
                  <div className="w-10 h-10 bg-teal-500 text-white rounded-full flex-shrink-0 flex justify-center items-center">
            ...
            >
              <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
                <div className="relative flex-shrink-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-teal-500 text-white rounded-full flex items-center justify-center">
                    <FaMicrophone className="w-5 h-5 sm:w-6 sm:h-6" />
                  </div>
                  <motion.div
                    animate={{ scale: [1, 1.2, 1] }}
                    transition={{ repeat: Infinity, duration: 1.5 }}
                    className="absolute inset-0 bg-teal-500 rounded-full opacity-25"
                  />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="font-medium text-teal-700 truncate">Recording...</p>
                  <p className="text-sm text-teal-600">{recordingTime}s</p>
                </div>
        ...
        <AnimatePresence>
          {isDragging && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="absolute inset-0 bg-teal-50/90 backdrop-blur-sm flex items-center justify-center rounded-lg z-10 border-2 border-dashed border-teal-300"
            >
              <div className="text-center">
                <div className="text-4xl mb-2">📎</div>
                <p className="text-teal-600 font-medium">Drop files to upload</p>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
        ...
        <form onSubmit={handleSubmit} className="flex items-center gap-2 w-full">
          <div className="flex-1 flex items-center gap-2 bg-gray-50 rounded-full px-3 py-2 min-w-0">
            <motion.button
              ...
              className="p-1.5 text-gray-500 hover:text-teal-500 transition-colors flex-shrink-0"
            >
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              <motion.button
                ...
                className="p-1.5 text-gray-500 hover:text-teal-500 transition-colors"
              >
              ...
              <motion.button
                ...
                className={`p-1.5 ${
                  isRecording ? 'text-red-500' : 'text-gray-500 hover:text-teal-500'
                } transition-colors`}
              >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            type="submit"
            className="p-2.5 bg-teal-500 text-white rounded-full hover:bg-teal-600 transition-colors shadow-lg flex-shrink-0"
            onClick={() => {
              if (isRecording) {
                stopRecording();
                sendVoiceMessage();
