...
const ScheduleMeetingModal = ({ 
  ...
  const datePickerOptions = {
    ...
    theme: {
      background: 'bg-white',
      todayBtn: 'bg-teal-500 hover:bg-teal-600',
      clearBtn: 'bg-gray-300 hover:bg-gray-400',
      icons: 'text-gray-600',
      text: 'text-gray-800',
      disabledText: 'text-gray-400',
      input: 'w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent',
