        ...
        <div className="flex items-center justify-between border-t pt-4">
          ...
          <div className="space-x-2">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-white bg-teal-500 hover:bg-teal-600 rounded-lg flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <Spin size="small" />
              ) : (
