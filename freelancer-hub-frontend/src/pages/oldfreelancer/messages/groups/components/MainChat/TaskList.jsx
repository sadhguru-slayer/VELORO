    ...
    <div className="p-4">
      ...
      <div className="mt-4 flex items-center">
        <input
          ...
          className="flex-1 px-3 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-violet-500"
        />
        <button
          onClick={handleAddTask}
          className="ml-2 p-2 bg-violet-500 text-white rounded-lg hover:bg-violet-600"
        >
